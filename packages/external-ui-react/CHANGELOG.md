...
- `ProgressBar` component behaved poorly when moving more than one step (forwards or backwards). Also cleaned up its Storybook.

## [2.39.0] - 2021-10-28

### Changed

- Rebranding for 2021: `Sidebar` component amended with `version` prop that defaults to `2021`. To retain earlier branding, set version to `2019`.
...
- `BlogExcerptCard` component.

### Changed

- `react-lottie` replaced with `lottie-react` library.
